...
#define NONE -1
#define KEY_ESC 0x1b
#define DIALOG_BORDER_COLOR COLOR_CODE_MAGENTA
#define ALERT_BORDER_COLOR COLOR_CODE_RED
#define SCROLLBAR_COLOR COLOR_CODE_MAGENTA
#define SCROLLBAR_BACK_COLOR COLOR_CODE_BLACK
#define HIGHLIGHT_COLOR COLOR_CODE_WHITE
#define MORECOLOR COLOR_CODE_ORANGE
#define STAT_UP_COLOR COLOR_CODE_GREEN
#define STAT_DOWN_COLOR COLOR_CODE_RED
