...
static NEARDATA struct artifact artilist[] = {
    ...
    A("", STRANGE_OBJECT, 0, 0, 0, NO_ATTK, NO_DFNS, NO_CARY, 0, A_NONE,
      NON_PM, NON_PM, 0L, COLOR_CODE_NONE, NONARTIFACT),
    ...
    A("Excalibur", LONG_SWORD, (SPFX_NOGEN | SPFX_RESTR | SPFX_SEEK
      ...
      4000L, COLOR_CODE_NONE, EXCALIBUR),
    /*
    ...
    A("Mjollnir", WAR_HAMMER, /* Mjo:llnir */
      ...
      A_NEUTRAL, PM_VALKYRIE, NON_PM, 4000L, COLOR_CODE_NONE, MJOLLNIR),

    A("Cleaver", BATTLE_AXE, SPFX_RESTR, 0, 0, PHYS(3, 6), NO_DFNS, NO_CARY,
      0, A_NEUTRAL, PM_BARBARIAN, NON_PM, 1500L, COLOR_CODE_NONE, CLEAVER),
    ...
    A("Grimtooth", ORCISH_DAGGER, (SPFX_RESTR | SPFX_WARN | SPFX_DFLAG2),
      ...
      NO_CARY, 0, A_CHAOTIC, NON_PM, PM_ORC, 300L, COLOR_CODE_RED, GRIMTOOTH),
    /*
    ...
    A("Snickersnee", KATANA, SPFX_RESTR, 0, 0, PHYS(0, 8), NO_DFNS, NO_CARY,
      0, A_LAWFUL, PM_SAMURAI, NON_PM, 1200L, COLOR_CODE_NONE, SNICKERSNEE),
    ...
    A("Sunsword", LONG_SWORD, (SPFX_RESTR | SPFX_DFLAG2), 0, M2_UNDEAD,
      ...
      NON_PM, 1500L, COLOR_CODE_NONE, SUNSWORD),
    ...
    A("The Orb of Detection", CRYSTAL_BALL,
      ...
      NO_ATTK, NO_DFNS, CARY(AD_MAGM), INVISIBLE, A_LAWFUL, PM_ARCHEOLOGIST,
      NON_PM, 2500L, COLOR_CODE_NONE, ORB_OF_DETECTION),

    A("The Heart of Ahriman", LUCKSTONE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), SPFX_STLTH, 0,
      /* this stone does double damage if used as a projectile weapon */
      PHYS(5, 0), NO_DFNS, NO_CARY, LEVITATION, A_NEUTRAL, PM_BARBARIAN,
      NON_PM, 2500L, COLOR_CODE_NONE, HEART_OF_AHRIMAN),
    ...
    A("The Sceptre of Might", MACE,
      ...
      2500L, COLOR_CODE_NONE, SCEPTRE_OF_MIGHT),
    ...
    A("The Palantir of Westernesse", CRYSTAL_BALL,
      ...
      COLOR_CODE_NONE, PALANTIR_OF_WESTERNESSE),
#endif
    ...
    A("The Staff of Aesculapius", QUARTERSTAFF,
      ...
      NON_PM, 5000L, COLOR_CODE_NONE, STAFF_OF_AESCULAPIUS),

    A("The Magic Mirror of Merlin", MIRROR,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_SPEAK), SPFX_ESP, 0,
      NO_ATTK, NO_DFNS, CARY(AD_MAGM), 0, A_LAWFUL, PM_KNIGHT, NON_PM, 1500L,
      COLOR_CODE_NONE, MAGIC_MIRROR_OF_MERLIN),

    A("The Eyes of the Overworld", LENSES,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_XRAY), 0, 0, NO_ATTK,
      DFNS(AD_MAGM), NO_CARY, ENLIGHTENING, A_NEUTRAL, PM_MONK, NON_PM, 2500L,
      COLOR_CODE_NONE, EYES_OF_THE_OVERWORLD),
    ...
    A("The Mitre of Holiness", HELM_OF_BRILLIANCE,
      ...
      PM_CLERIC, NON_PM, 2000L, COLOR_CODE_NONE, MITRE_OF_HOLINESS),

    A("The Longbow of Diana", BOW,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_REFLECT), SPFX_ESP, 0,
      PHYS(5, 0), NO_DFNS, NO_CARY, CREATE_AMMO, A_CHAOTIC, PM_RANGER, NON_PM,
      4000L, COLOR_CODE_NONE, LONGBOW_OF_DIANA),
    ...
    A("The Master Key of Thievery", SKELETON_KEY,
      ...
      UNTRAP, A_CHAOTIC, PM_ROGUE, NON_PM, 3500L, COLOR_CODE_NONE,
