...
#define PCHAR2(idx, ch, sym, tilenm, desc, clr) PCHAR(idx, ch, sym, desc, clr)
    ...
    PCHAR2( 0, ' ',  S_stone,  "dark part of a room", "stone",  COLOR_CODE_NONE)
    PCHAR2( 1, '|',  S_vwall,  "vertical wall", "wall",  COLOR_CODE_GRAY)
    PCHAR2( 2, '-',  S_hwall,  "horizontal wall", "wall",  COLOR_CODE_GRAY)
    PCHAR2( 3, '-',  S_tlcorn, "top left corner wall", "wall",  COLOR_CODE_GRAY)
    PCHAR2( 4, '-',  S_trcorn, "top right corner wall", "wall",  COLOR_CODE_GRAY)
    PCHAR2( 5, '-',  S_blcorn, "bottom left corner wall", "wall", COLOR_CODE_GRAY)
    PCHAR2( 6, '-',  S_brcorn, "bottom right corner wall", "wall", COLOR_CODE_GRAY)
    PCHAR2( 7, '-',  S_crwall, "cross wall", "wall", COLOR_CODE_GRAY)
    PCHAR2( 8, '-',  S_tuwall, "tuwall", "wall", COLOR_CODE_GRAY)
    PCHAR2( 9, '-',  S_tdwall, "tdwall", "wall", COLOR_CODE_GRAY)
    PCHAR2(10, '|',  S_tlwall, "tlwall", "wall", COLOR_CODE_GRAY)
    PCHAR2(11, '|',  S_trwall, "trwall", "wall", COLOR_CODE_GRAY)
    /* start cmap A                                                      */
    PCHAR2(12, '.',  S_ndoor,  "no door", "doorway", COLOR_CODE_GRAY)
    PCHAR2(13, '-',  S_vodoor, "vertical open door", "open door", COLOR_CODE_BROWN)
    PCHAR2(14, '|',  S_hodoor, "horizontal open door", "open door", COLOR_CODE_BROWN)
    PCHAR2(15, '+',  S_vcdoor, "vertical closed door",
                               "closed door", COLOR_CODE_BROWN)
    PCHAR2(16, '+',  S_hcdoor, "horizontal closed door",
                               "closed door", COLOR_CODE_BROWN)
    PCHAR( 17, '#',  S_bars,   "iron bars", HI_METAL)
    PCHAR( 18, '#',  S_tree,   "tree", COLOR_CODE_GREEN)
    PCHAR( 19, '.',  S_room,   "floor of a room", COLOR_CODE_GRAY)
    PCHAR( 20, '.',  S_darkroom, "dark part of a room", COLOR_CODE_BLACK)
    PCHAR2(21, '`',  S_engroom, "engraving in a room", "engraving",
                                COLOR_CODE_BRIGHT_BLUE)
    PCHAR2(22, '#',  S_corr,   "dark corridor", "corridor", COLOR_CODE_GRAY)
    PCHAR( 23, '#',  S_litcorr, "lit corridor", COLOR_CODE_GRAY)
    PCHAR2(24, '#',  S_engrcorr, "engraving in a corridor", "engraving",
                                 COLOR_CODE_BRIGHT_BLUE)
    PCHAR2(25, '<',  S_upstair, "up stairs", "staircase up", COLOR_CODE_GRAY)
    PCHAR2(26, '>',  S_dnstair, "down stairs", "staircase down", COLOR_CODE_GRAY)
    PCHAR2(27, '<',  S_upladder, "up ladder", "ladder up", COLOR_CODE_BROWN)
    PCHAR2(28, '>',  S_dnladder, "down ladder", "ladder down", COLOR_CODE_BROWN)
    PCHAR( 29, '<',  S_brupstair, "branch staircase up", COLOR_CODE_YELLOW)
    PCHAR( 30, '>',  S_brdnstair, "branch staircase down", COLOR_CODE_YELLOW)
    PCHAR( 31, '<',  S_brupladder, "branch ladder up", COLOR_CODE_YELLOW)
    PCHAR( 32, '>',  S_brdnladder, "branch ladder down", COLOR_CODE_YELLOW)
    /* end cmap A */
    PCHAR( 33, '_',  S_altar,  "altar", COLOR_CODE_GRAY)
    /* start cmap B */
    PCHAR( 34, '|',  S_grave,  "grave", COLOR_CODE_WHITE)
    PCHAR2(35, '\\', S_throne, "throne", "opulent throne", HI_GOLD)
    PCHAR( 36, '{',  S_sink,   "sink", COLOR_CODE_WHITE)
    PCHAR( 37, '{',  S_fountain, "fountain", COLOR_CODE_BRIGHT_BLUE)
    PCHAR2(38, '}',  S_pool,   "pool", "water", COLOR_CODE_BLUE)
    PCHAR( 39, '.',  S_ice,    "ice", COLOR_CODE_CYAN)
    PCHAR( 40, '}',  S_lava,   "molten lava", COLOR_CODE_RED)
    PCHAR( 41, '}',  S_lavawall,  "wall of lava", COLOR_CODE_ORANGE)
    PCHAR2(42, '.',  S_vodbridge, "vertical open drawbridge",
                                  "lowered drawbridge", COLOR_CODE_BROWN)
    PCHAR2(43, '.',  S_hodbridge, "horizontal open drawbridge",
                                  "lowered drawbridge", COLOR_CODE_BROWN)
    PCHAR2(44, '#',  S_vcdbridge, "vertical closed drawbridge",
                                  "raised drawbridge", COLOR_CODE_BROWN)
    PCHAR2(45, '#',  S_hcdbridge, "horizontal closed drawbridge",
                                  "raised drawbridge", COLOR_CODE_BROWN)
    PCHAR( 46, ' ',  S_air,    "air", COLOR_CODE_CYAN)
    PCHAR( 47, '#',  S_cloud,  "cloud", COLOR_CODE_GRAY)
    PCHAR( 48, '}',  S_water,  "water", COLOR_CODE_BRIGHT_BLUE)
    ...
    PCHAR( 51, '^',  S_falling_rock_trap, "falling rock trap", COLOR_CODE_GRAY)
    PCHAR( 52, '^',  S_squeaky_board, "squeaky board", COLOR_CODE_BROWN)
    PCHAR( 53, '^',  S_bear_trap, "bear trap", HI_METAL)
    PCHAR( 54, '^',  S_land_mine, "land mine", COLOR_CODE_RED)
    PCHAR( 55, '^',  S_rolling_boulder_trap, "rolling boulder trap", COLOR_CODE_GRAY)
    PCHAR( 56, '^',  S_sleeping_gas_trap, "sleeping gas trap", HI_ZAP)
    PCHAR( 57, '^',  S_rust_trap, "rust trap", COLOR_CODE_BLUE)
    PCHAR( 58, '^',  S_fire_trap, "fire trap", COLOR_CODE_ORANGE)
    PCHAR( 59, '^',  S_pit, "pit", COLOR_CODE_BLACK)
    PCHAR( 60, '^',  S_spiked_pit, "spiked pit", COLOR_CODE_BLACK)
    PCHAR( 61, '^',  S_hole, "hole", COLOR_CODE_BROWN)
    PCHAR( 62, '^',  S_trap_door, "trap door", COLOR_CODE_BROWN)
    PCHAR( 63, '^',  S_teleportation_trap, "teleportation trap", COLOR_CODE_MAGENTA)
    PCHAR( 64, '^',  S_level_teleporter, "level teleporter", COLOR_CODE_MAGENTA)
    PCHAR( 65, '^',  S_magic_portal, "magic portal", COLOR_CODE_BRIGHT_MAGENTA)
    PCHAR( 66, '"',  S_web, "web", COLOR_CODE_GRAY)
    PCHAR( 67, '^',  S_statue_trap, "statue trap", COLOR_CODE_GRAY)
    PCHAR( 68, '^',  S_magic_trap, "magic trap", HI_ZAP)
    PCHAR2(69, '^',  S_anti_magic_trap, "anti magic trap", "anti-magic field",
                                        HI_ZAP)
    PCHAR( 70, '^',  S_polymorph_trap, "polymorph trap", COLOR_CODE_BRIGHT_GREEN)
    PCHAR( 71, '~',  S_vibrating_square, "vibrating square", COLOR_CODE_MAGENTA)
    PCHAR( 72, '^',  S_trapped_door, "trapped door", COLOR_CODE_ORANGE)
    PCHAR( 73, '^',  S_trapped_chest, "trapped chest", COLOR_CODE_ORANGE)
    /* end traps                                                       */
    /* end cmap B */
    /*                                                                   */
    ...
    /*                                                                   */
    PCHAR2(74, '|',  S_vbeam, "vertical beam", "", COLOR_CODE_GRAY)
    PCHAR2(75, '-',  S_hbeam, "horizontal beam", "", COLOR_CODE_GRAY)
    PCHAR2(76, '\\', S_lslant, "left slant beam", "", COLOR_CODE_GRAY)
    PCHAR2(77, '/',  S_rslant, "right slant beam", "", COLOR_CODE_GRAY)
    /* start cmap C */
    PCHAR2(78, '*',  S_digbeam, "dig beam", "", COLOR_CODE_WHITE)
    PCHAR2(79, '!',  S_flashbeam, "flash beam", "", COLOR_CODE_WHITE)
    ...
    PCHAR( 86, '#',  S_poisoncloud, "poison cloud", COLOR_CODE_BRIGHT_GREEN)
    ...
    /*      7 8 9                                                  */
    /*                                                             */
    PCHAR2(88, '/',  S_sw_tl, "swallow top left", "", COLOR_CODE_GREEN)      /*1*/
    PCHAR2(89, '-',  S_sw_tc, "swallow top center", "", COLOR_CODE_GREEN)    /*2*/
    PCHAR2(90, '\\', S_sw_tr, "swallow top right", "", COLOR_CODE_GREEN)     /*3*/
    PCHAR2(91, '|',  S_sw_ml, "swallow middle left", "", COLOR_CODE_GREEN)   /*4*/
    PCHAR2(92, '|',  S_sw_mr, "swallow middle right", "", COLOR_CODE_GREEN)  /*6*/
    PCHAR2(93, '\\', S_sw_bl, "swallow bottom left", "", COLOR_CODE_GREEN)   /*7*/
    PCHAR2(94, '-',  S_sw_bc, "swallow bottom center", "", COLOR_CODE_GREEN) /*8*/
    PCHAR2(95, '/',  S_sw_br, "swallow bottom right", "", COLOR_CODE_GREEN)  /*9*/
    /*                                                             */
    ...
    /*      \-/                                                    */
    /*                                                             */
    PCHAR2(96, '/',  S_expl_tl, "explosion top left", "", COLOR_CODE_ORANGE)
    PCHAR2(97, '-',  S_expl_tc, "explosion top center", "", COLOR_CODE_ORANGE)
    PCHAR2(98, '\\', S_expl_tr, "explosion top right", "", COLOR_CODE_ORANGE)
    PCHAR2(99, '|',  S_expl_ml, "explosion middle left", "", COLOR_CODE_ORANGE)
    PCHAR2(100, ' ',  S_expl_mc, "explosion middle center", "", COLOR_CODE_ORANGE)
    PCHAR2(101, '|',  S_expl_mr, "explosion middle right", "", COLOR_CODE_ORANGE)
    PCHAR2(102, '\\', S_expl_bl, "explosion bottom left", "", COLOR_CODE_ORANGE)
    PCHAR2(103, '-', S_expl_bc, "explosion bottom center", "", COLOR_CODE_ORANGE)
    PCHAR2(104, '/', S_expl_br, "explosion bottom right", "", COLOR_CODE_ORANGE)
#undef PCHAR
#undef PCHAR2
