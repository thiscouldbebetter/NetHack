...
/* For efficiency, we only check every NHIGHLIGHT_SB_STEPSIZE instructions. */
#ifndef NHIGHLIGHT_SB_STEPSIZE
#define NHIGHLIGHT_SB_STEPSIZE 1000
#endif

/* High level groups.  Use these flags. */
    /* Safe functions. */
#define NHIGHLIGHT_SB_SAFE        0x80000000
    /* Access to Lua version information. */
#define NHIGHLIGHT_SB_VERSION     0x40000000
    /* Debugging library - mostly unsafe. */
#define NHIGHLIGHT_SB_DEBUGGING   0x08000000

/* Low level groups.  If you need these, you probably need to define
 * a new high level group instead. */
#define NHIGHLIGHT_SB_STRING      0x00000001
#define NHIGHLIGHT_SB_TABLE       0x00000002
#define NHIGHLIGHT_SB_COROUTINE   0x00000004
#define NHIGHLIGHT_SB_MATH        0x00000008
#define NHIGHLIGHT_SB_UTF8        0x00000010
#ifdef notyet
#define NHIGHLIGHT_SB_IO          0x00000020
#endif
#define NHIGHLIGHT_SB_OS          0x00000040

#define NHIGHLIGHT_SB_BASEMASK    0x00000f80
#define NHIGHLIGHT_SB_BASE_BASE   0x00000080
#define NHIGHLIGHT_SB_BASE_ERROR  0x00000100
#define NHIGHLIGHT_SB_BASE_META   0x00000200
#define NHIGHLIGHT_SB_BASE_GC     0x00000400
#define NHIGHLIGHT_SB_BASE_UNSAFE 0x00000800

#define NHIGHLIGHT_SB_DBMASK      0x00003000
#define NHIGHLIGHT_SB_DB_DB       0x00001000
#define NHIGHLIGHT_SB_DB_SAFE     0x00002000

#define NHIGHLIGHT_SB_OSMASK      0x0000c000
#define NHIGHLIGHT_SB_OS_TIME     0x00004000
#define NHIGHLIGHT_SB_OS_FILES    0x00008000

#define NHIGHLIGHT_SB_ALL         0x0000ffff

/* return codes */
#define NHIGHLIGHT_SBRV_DENY 1
#define NHIGHLIGHT_SBRV_ACCEPT 2
#define NHIGHLIGHT_SBRV_FAIL 3

/* NHIGHLIGHT_pcall_handle action values */
typedef enum NHIGHLIGHT_pcall_action {
    NHLpa_panic,
    NHLpa_impossible
} NHIGHLIGHT_pcall_action;
