...
#endif
DRGN_ARMR("red dragon scale mail",     1, FIRE_RES,    900, 1, COLOR_CODE_RED,
                                                    RED_DRAGON_SCALE_MAIL),
DRGN_ARMR("white dragon scale mail",   1, COLD_RES,    900, 1, COLOR_CODE_WHITE,
                                                    WHITE_DRAGON_SCALE_MAIL),
DRGN_ARMR("orange dragon scale mail",  1, SLEEP_RES,   900, 1, COLOR_CODE_ORANGE,
                                                    ORANGE_DRAGON_SCALE_MAIL),
DRGN_ARMR("black dragon scale mail",   1, DISINT_RES, 1200, 1, COLOR_CODE_BLACK,
                                                    BLACK_DRAGON_SCALE_MAIL),
DRGN_ARMR("blue dragon scale mail",    1, SHOCK_RES,   900, 1, COLOR_CODE_BLUE,
                                                    BLUE_DRAGON_SCALE_MAIL),
DRGN_ARMR("green dragon scale mail",   1, POISON_RES,  900, 1, COLOR_CODE_GREEN,
                                                    GREEN_DRAGON_SCALE_MAIL),
DRGN_ARMR("yellow dragon scale mail",  1, ACID_RES,    900, 1, COLOR_CODE_YELLOW,
...
#endif
DRGN_ARMR("red dragon scales",         0, FIRE_RES,    500, 7, COLOR_CODE_RED,
                                                        RED_DRAGON_SCALES),
DRGN_ARMR("white dragon scales",       0, COLD_RES,    500, 7, COLOR_CODE_WHITE,
                                                        WHITE_DRAGON_SCALES),
DRGN_ARMR("orange dragon scales",      0, SLEEP_RES,   500, 7, COLOR_CODE_ORANGE,
                                                        ORANGE_DRAGON_SCALES),
DRGN_ARMR("black dragon scales",       0, DISINT_RES,  700, 7, COLOR_CODE_BLACK,
                                                        BLACK_DRAGON_SCALES),
DRGN_ARMR("blue dragon scales",        0, SHOCK_RES,   500, 7, COLOR_CODE_BLUE,
                                                        BLUE_DRAGON_SCALES),
DRGN_ARMR("green dragon scales",       0, POISON_RES,  500, 7, COLOR_CODE_GREEN,
                                                        GREEN_DRAGON_SCALES),
DRGN_ARMR("yellow dragon scales",      0, ACID_RES,    500, 7, COLOR_CODE_YELLOW,
...
CLOAK("alchemy smock", "apron",
      0, 1, POISON_RES,  9, 0, 10, 50,  9, 1,  CLOTH, COLOR_CODE_WHITE, ALCHEMY_SMOCK),
...
CLOAK("cloak of invisibility", "opera cloak",
      0, 1,      INVIS, 10, 0, 10, 60,  9, 1,  CLOTH, COLOR_CODE_BRIGHT_MAGENTA,
...
RING("poison resistance", "pearl",
     POISON_RES,               150, 1, 0,  4, BONE, COLOR_CODE_WHITE,
...
RING("protection from shape changers", "shiny",
     PROT_FROM_SHAPE_CHANGERS, 100, 1, 0,  5, IRON, COLOR_CODE_BRIGHT_CYAN,
...
POTION("levitation",             "cyan",  1, LEVITATION, 40, 200, COLOR_CODE_CYAN,
                                                        POT_LEVITATION),
POTION("hallucination",      "sky blue",  1, HALLUC, 30, 100, COLOR_CODE_CYAN,
                                                        POT_HALLUCINATION),
POTION("invisibility", "brilliant blue",  1, INVIS, 40, 150, COLOR_CODE_BRIGHT_BLUE,
                                                        POT_INVISIBILITY),
POTION("see invisible",       "magenta",  1, SEE_INVIS, 40, 50, COLOR_CODE_MAGENTA,
                                                        POT_SEE_INVISIBLE),
